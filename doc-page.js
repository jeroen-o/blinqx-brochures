...
(() => {
  ...
  class DocPage extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // Children may already be present at connect (frameworks that build
      // the subtree before insertion): the observer then never fires, so
      // pagination would never be detected. Measure once up front.
    ...
    _render() {
      ...
      if (this.querySelector(':scope > .page')) {
        this._sheet.classList.add('paginated');
      }
    }
